...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 05, 2024 at 05:52 PM
...
('KOK001', 'KOKI', 'Koki', 'Laki-laki', 'koki', '123'),
('KSR001', 'Kasir', 'Kasir', 'Laki-laki', 'kasir', '123'),
('PYN001', 'pelayan', 'Pelayan', 'Laki-laki', 'pelayan', '123');
...
(3, '2024-08-04', 15000.00, 1500.00, 16500.00, 17000.00, 500.00, 'Sudah Bayar', 'KSR001'),
(4, '2024-07-22', 45000.00, 4500.00, 49500.00, 50000.00, 500.00, 'Sudah Bayar', 'KSR001'),
(5, '2024-08-04', 80000.00, 8000.00, 88000.00, 100000.00, 12000.00, 'Sudah Bayar', 'KSR001');
...
--
ALTER TABLE `pemesanan`
  MODIFY `no_pemesanan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
